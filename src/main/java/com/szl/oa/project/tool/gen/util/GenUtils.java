package com.szl.oa.project.tool.gen.util;

import com.szl.oa.common.constant.CommonMap;
...
import com.szl.oa.framework.config.GenConfig;
...
{
    /** 项目空间路径 */
    private static final String PROJECT_PATH = "main/java/com/szl.oa/project";
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(getModuleName("com.szl.oa.project.system"));
    }
}
